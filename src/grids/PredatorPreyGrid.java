    ...
    protected void setCellState (GridCell cell) {
        ...
        if (cell instanceof SharkCell) {
            ...
            if (cell.getMyNextState() == State.DEAD) {
                getMyCells()[cell.getMyGridLocation().getRow()][cell.getMyGridLocation().getCol()] =
                        new SimpleCell(State.EMPTY, cell.getMyGridLocation().getRow(),
                                       cell.getMyGridLocation().getCol(),
                                       new Rectangle(getMyCellSize(), getMyCellSize()));
            }
            else {
