...
public class Constants {
    ...
    public static final Dimension DEFAULT_WINDOW_SIZE = new Dimension(Integer.parseInt(RESOURCES.getString("defaultWindowWidth")), Integer.parseInt(RESOURCES.getString("defaultWindowHeight")));
