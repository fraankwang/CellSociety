...
public class dynamicchart extends Application {
    ...
    public void init () throws Exception {
        ...
        events = FXCollections.observableArrayList(
                                                   new Event("Javelin", "6 6",
                                                             FXCollections.observableArrayList(
                                                                                               createSeries("Javelin - Tokyo",
                                                                                                            FXCollections
                                                                                                                    .observableArrayList(18,
                                                                                                                                         20,
                                                                                                                                         22)),
                                                                                               createSeries("Javelin - Kyoto",
                                                                                                            FXCollections
                                                                                                                    .observableArrayList(23,
                                                                                                                                         14,
                                                                                                                                         15)))),
                                                   new Event("Hammer", "12 2 2 12",
                                                             FXCollections.observableArrayList(
                                                                                               createSeries("Hammer - Tokyo",
                                                                                                            FXCollections
                                                                                                                    .observableArrayList(12,
                                                                                                                                         11,
                                                                                                                                         5)),
        ...
        for (final Event event : events) {
            ...
            if (event.getStrokeDashArray() != null && !event.getStrokeDashArray().isEmpty()) {
                styleString.append("-fx-stroke-dash-array: ").append(event.getStrokeDashArray())
                        .append(";");
            }
    ...
    private void styleSeries (ObservableList<Event> events,
        ...
        // mark different series with different depending on whether they are above or below
        // average.
        int nSeries = 0;
        for (Event event : events) {
            if (!event.isActive()) {
            ...
            for (int j = 0; j < event.getSeries().size(); j++) {
                ...
                for (Node n : nodes) {
                    ...
                    if (event.getStrokeDashArray() != null &&
                        ...
                        style.append("-fx-stroke-dash-array: ").append(event.getStrokeDashArray())
                                .append(";");
                    }
    ...
    private XYChart.Series<Number, Number> createSeries (String name, List<Number> data) {
        ...
        series.setName(name);
        ObservableList<XYChart.Data<Number, Number>> seriesData =
                FXCollections.observableArrayList();
